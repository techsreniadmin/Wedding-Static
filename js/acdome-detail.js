...
// JavaScript for AC Dome venue detail page
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // If no venue ID is provided, redirect to AC dome page
  if (!venueId) {
    window.location.href = 'ac-dome.html';
    return;
  }
  
  // Find the venue data
  const venue = venueData.acDomes.find(dome => dome.id === venueId);
  
  // If venue not found, redirect to AC dome page
  if (!venue) {
    window.location.href = 'ac-dome.html';
    return;
  }
